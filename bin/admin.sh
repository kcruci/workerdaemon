...
RUN_EXE=`find $MCURDIR/.. -name $proccName`
...
case  $fstPara in
		start|Start)
            ...
            echo "starting $proccName"
#            echo "./worker_server ${CONFDIR}/fnf_worker_redis.xml ${CONFDIR}/fnf_worker_mysql.xml ${CONFDIR}/keylist.xml ${CONFDIR}/log.conf 1 2  1-10"
            $RUN_EXE ${CONFDIR}/fnf_worker_redis.xml ${CONFDIR}/fnf_worker_mysql.xml ${CONFDIR}/keylist.xml ${CONFDIR}/log.conf 1 20  1-1
		;;
