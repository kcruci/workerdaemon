...
case  $fstPara in
        start|Start)
            ...
            echo "###########################################################################################"
            echo "$RUN_EXE ${CONFDIR}/fnf_worker_redis.xml ${CONFDIR}/fnf_worker_mysql.xml ${CONFDIR}/keylist.xml ${CONFDIR}/log.conf 1 900  1-8"
            echo "###########################################################################################"
            #echo "./worker_server ${CONFDIR}/fnf_worker_redis.xml ${CONFDIR}/fnf_worker_mysql.xml ${CONFDIR}/keylist.xml ${CONFDIR}/log.conf 1 900  1-10"
            $RUN_EXE ${CONFDIR}/fnf_worker_redis.xml ${CONFDIR}/fnf_worker_mysql.xml ${CONFDIR}/keylist.xml ${CONFDIR}/log.conf 1 900  1-8
        ;;
